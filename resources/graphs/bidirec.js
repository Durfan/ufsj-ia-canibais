const gData = {
	...
	{ id: 24, name: "(2,0,1)", color: "red" },
	{ id: 23, name: "(1,3,1)", color: "red" },
	{ id: 22, name: "(1,2,1)", color: "red" },
	{ id: 21, name: "(1,1,1)" },
	{ id: 20, name: "(1,0,1)", color: "red" },
	{ id: 19, name: "(0,3,1)" },
	{ id: 18, name: "(0,2,1)" },
	{ id: 17, name: "(0,1,1)" },
	{ id: 14, name: "(0,1,0)" },
	...
	links: [
	{ target: 17, source: 0, name: "0,1" },
	{ target: 18, source: 0, name: "0,2" },
	{ target: 20, source: 0, name: "1,0" },
	{ target: 21, source: 0, name: "1,1" },
	{ target: 24, source: 0, name: "2,0" },
	{ target: 19, source: 1, name: "0,2" },
	{ target: 22, source: 1, name: "1,1" },
	{ target: 25, source: 1, name: "2,0" },
	{ target: 23, source: 2, name: "1,1" },
	{ target: 26, source: 2, name: "2,0" },
	{ target: 29, source: 5, name: "2,0" },
	{ target: 27, source: 10, name: "0,1" },
	{ target: 29, source: 12, name: "0,1" },
	{ target: 30, source: 13, name: "0,1" },
	{ target: 1, source: 18, name: "0,1" },
	{ target: 2, source: 19, name: "0,1" },
	{ target: 4, source: 21, name: "0,1" },
	{ target: 5, source: 26, name: "1,1" },
	{ target: 8, source: 26, name: "0,2" },
...
$('span.memoria').text('28');
$('span.tempo').text('0.000527s');